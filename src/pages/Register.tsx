        ...
        <div className="w-full md:w-7/12 p-16 overflow-y-auto max-h-[85vh]">
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="flex gap-4 p-1 bg-white/5 border border-white/10 mb-8">
              <button
                type="button"
                onClick={() => setRole(UserRole.VISITOR)}
                className={`flex-1 py-3 text-[9px] font-bold uppercase tracking-widest transition-all ${role === UserRole.VISITOR ? 'bg-amber-600 text-black' : 'text-gray-500 hover:text-white'}`}
              >
                Customer
              </button>
              <button
                ...
                className={`flex-1 py-3 text-[9px] font-bold uppercase tracking-widest transition-all ${role === UserRole.OWNER ? 'bg-amber-600 text-black' : 'text-gray-500 hover:text-white'}`}
              >
                Shop Owner
              </button>
            </div>
            ...
            <div className="pt-10">
              <button
                type="submit"
                disabled={loading}
                className="w-full py-6 bg-white text-black font-black uppercase tracking-[0.4em] text-[10px] hover:bg-amber-600 hover:text-white transition-all duration-500 disabled:opacity-50"
              >
